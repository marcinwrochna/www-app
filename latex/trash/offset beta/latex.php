...
// offset: repeats the processing to show the normal image without any vertical alignment.
// so only required for comparison purposes
function latex_content_nooffset($text) {
    // --------------------------------------------------------------------------------------------------
    // adjust this to match your system configuration
    $latexrender_path = "/home/domain_name/public_html/latexrender";
    $latexrender_path_http = "/latexrender";
