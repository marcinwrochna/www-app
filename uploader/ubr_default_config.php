...
$_CONFIG['upload_dir']                            = $_SERVER['DOCUMENT_ROOT'] . '/';                                                                   // Path to upload directory
$_CONFIG['max_upload_slots']                      = 25;                                                                                                            // Maximum number of files a user can upload at once
...
$_CONFIG['check_file_name_error_message']         = 'Błąd, nazwa plików może jedynie zawierać znaki  1-9, a-z, A-Z, _, -';                                         // Error message used for client side regex fail
...
$_CONFIG['max_upload_size']                       = 152428800;                                                                                                      // Maximum upload size (5 * 1024 * 1024 = 5242880 = 5MB)
$_CONFIG['overwrite_existing_files']              = 0;                                                                                                            // Overwrite any existing files by the same name in the upload folder
$_CONFIG['redirect_url']                          = 'http://'. $_SERVER['HTTP_HOST'] . '/uploader/ubr_finished.php';                                               // What page to load after the upload completes (only used if REDIRECT_METHOD ini setting is > 0)
...
$_CONFIG['max_file_name_chars']                   = 148;                                                                                                           // The maximum characters allowed in the file name
$_CONFIG['min_file_name_chars']                   = 3;                                                                                                             // The maximum characters allowed in the file name
...
$_CONFIG['path_to_upload']                        = 'http://'. $_SERVER['HTTP_HOST'] . '/';                                                               // Used for a web link to the uploaded file
...
$_CONFIG['log_dir']                               = $_SERVER['DOCUMENT_ROOT'] . '/uploader/logs/';                                                                 // Path to log directory
