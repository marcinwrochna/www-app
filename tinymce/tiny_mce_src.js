...
(function(tinymce) {
	...
	tinymce.create('tinymce.dom.Selection', {
		...
		getContent : function(s) {
			var t = this, r = t.getRng(), e = t.dom.create("body"), se = t.getSel(), wb, wa, n,wtf;
		...
		setContent : function(h, s) {
			...
			if (r.insertNode) {
				...
				if (r.startContainer == d && r.endContainer == d) {
					...
					r.deleteContents();
					//if (isChrome)  alert('Alerting here helps, like some kind of magic.');
					//TOKEN workaround : r.insertNode(t.getRng().createContextualFragment(h));
