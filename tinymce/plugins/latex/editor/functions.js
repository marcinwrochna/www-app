function insert(aTag, eTag) {
  var input = document.forms.latexform.elements.formula;
...
function menu(ITEMS) {
  ...
  for(i=0;i<ITEMS.length;i++) {
    ...
    document.write('</map>');
    document.write('<img src="editor/menus/'+compmenu+'.gif" alt="'+longmenu+'" usemap="#'+compmenu+'" style="background:#ffffff; border: 1px solid #255B73"/>');
    document.write('</div>');
  }
